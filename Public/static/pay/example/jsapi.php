...
$input->SetBody("代鼠发单付款");
$input->SetAttach("代鼠发单付款");
$input->SetOut_trade_no(WxPayConfig::MCHID.date("YmdHis"));
$money = $_SESSION['sum']*100;
$input->SetTotal_fee($money);
$input->SetTime_start(date("YmdHis"));
$input->SetTime_expire(date("YmdHis", time() + 600));
$input->SetGoods_tag("代鼠发单付款");
$input->SetNotify_url("http://www.doododo.com?s=/Home/Pay/save");
  ...
  <title>微信支付</title>
	...
	function jsApiCall()
	{
        ...
        if (res.err_msg == "get_brand_wcpay_request:ok") {
        	...
        	window.location.href="http://www.doododo.com?s=/Home/Pay/save";
...
<body>
  ...
  <div class="balance-border">
			<div class="balance-money">
				<h4>调用微信钱包接口支付:</h4>
				<h1 style="text-align:center;"><?php echo ($_SESSION['sum']);?>元</h1>
			</div>
		</div>
