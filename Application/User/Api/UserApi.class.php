...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '', $sex, $attend, $school, $academy){
        return $this->model->register($username, $password, $email, $mobile, $sex, $attend, $school, $academy);
    }
