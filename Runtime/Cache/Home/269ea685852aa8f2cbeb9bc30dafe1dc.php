	...
	<body>
		...
		<div class="balance-border">
			<div class="balance-money">
				<h4>确认充值金额:</h4>
				<h1 style="text-align:center;"><?php echo ($money); ?>元</h1>
			</div>
		</div>
		<div class="re-pay">
			<a class=" btn btn-warning btn-lg btn-block " onclick="window.location.href='http://www.doododo.com/Public/static/pay/example/recharge.php'" role="button">确认充值</a>
		</div>
		<!--<div class="head">
		</div>-->
